...
- **Блокирующие проверки (Sanity Checks):** `4 / 6 пройдены` (CP-0.3: Gamma Audit, CP-0.4: Identity Check, CP-0.6: Box Calibration, CP-0.7: FLOPs Invariance)
...
| $\rho(L, Y)$ | Корреляция Пирсона карты L и яркости Y | $> 0.5$ | *Pending CP-0.5* | `scripts/corr_LY.py` | |
